...
namespace Company.Language12
{
	...
	/// </summary>
	internal partial class Language12CommandSet : Language12CommandSetBase
	{
		/// <summary>
		/// Constructs a new Language12CommandSet.
		/// </summary>
		public Language12CommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class Language12CommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new Language12CommandSetBase.
		/// </summary>
		protected Language12CommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewLanguage12ExplorerCommand,
				typeof(Language12EditorFactory).GUID);
		...
		{
			Language12ExplorerToolWindow explorer = this.Language12ExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected Language12DocData CurrentLanguage12DocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as Language12DocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected Language12DocView CurrentLanguage12DocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as Language12DocView;
			}
		}
		...
		/// </summary>
		protected Language12ExplorerToolWindow Language12ExplorerToolWindow
		{
			get
			{
				Language12ExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(Language12ExplorerToolWindow), true) as Language12ExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				Language12ExplorerToolWindow explorerWindow = this.Language12ExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class Language12ClipboardCommandSet : Language12ClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new Language12ClipboardCommandSet.
		/// </summary>
		public Language12ClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class Language12ClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new Language12ClipboardCommandSetBase.
		/// </summary>
		protected Language12ClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
