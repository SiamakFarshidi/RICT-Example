...
namespace Company.Language12
{
	...
	/// </summary>
	internal partial class Language12DocView : Language12DocViewBase
	{
		/// <summary>
		/// Constructs a new Language12DocView.
		/// </summary>
		public Language12DocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class Language12DocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new Language12DocView.
		/// </summary>
		protected Language12DocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			Language12DocDataBase docData = this.DocData as Language12DocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for Language12DocViewBase should be an Language12DocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.Language12.Language12Diagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.Language12.Language12Diagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.Language12.Language12ToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.Language12.Language12ToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.Language12DiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.Language12.Language12HelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.Language12.Language12HelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.Language12.Language12HelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
