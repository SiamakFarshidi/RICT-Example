...
namespace Company.Language12
{
	...
	/// </summary>
	internal partial class Language12Explorer : Language12ExplorerBase
	{
		/// <summary>
		/// Constructs a new Language12Explorer.
		/// </summary>
		public Language12Explorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the Language12ExplorerToolWindow.
	/// </summary>
	internal abstract class Language12ExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new Language12ExplorerBase.
		/// </summary>
		protected Language12ExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.Language12ExplorerMenu;
			}
		}
		...
		{
			get { return global::Company.Language12.World.DomainClassId; }
		}
