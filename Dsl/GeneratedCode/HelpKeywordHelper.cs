...
namespace Company.Language12
{
	...
	/// </remarks>
	public partial class Language12HelpKeywordHelper : Language12HelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new Language12HelpKeywordHelper.
		/// </summary>
		protected Language12HelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the Language12HelpKeywordHelper.
		/// </summary>
		public static Language12HelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class Language12HelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new Language12HelpKeywordHelperBase.
		/// </summary>
		protected Language12HelpKeywordHelperBase()
			: base() { }
